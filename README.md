...
BAIXE A ISO DO ARCH LINUX NO LINK: https://archlinux.c3sl.ufpr.br/iso/2026.08.01/archlinux-x86_64.iso
...
ABRIR WOFI (MENU DE PROGRAMAS): SUPER + X

ENTRA OU SAIR NO MODO TELA CHEIA: SUPER + C "O CURSOR DO MOUSE PRECISA ESTA DENTRO DO ESPAÇO DO PROGRAMA"

REINICIAR CONFIGURAÇÕES DO SWAY: SUPER + V
...
onlyoffice (visualizador/modificador gratis de pdf, word, etc) = i onlyoffice
...
minecraft bedrock (original não oficial, precisa ter comprado pela play store) = i mcpelauncher-linux
...
sober (roblox player {funcionando}) = i flatpak && flatpak install flathub org.vinegarhq.Sober -y
