OI, SEJA BEM VINDO AO MEU PROJETO QUE SE CHAMA "ZL ARCH LINUX", É UM PROJETO QUE AUTOMATIZA A INSTALAÇÃO DO ARCH LINUX PARA QUE NÃO PERCA TEMPO DIGITANDO COMANDOS, PARA MAIS INFORMAÇÕES LEIA OS TÓPICOS ABAIXO.
