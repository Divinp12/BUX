...
FECHAR PROGRAMA: SUPER + X "O CURSOR DO MOUSE PRECISA ESTA DENTRO DO ESPAÇO DO PROGRAMA"

REINICIAR CONFIGURAÇÕES DO SWAY: SUPER + C

ABRIR WOFI (MENU DE PROGRAMAS): SUPER + V

ENTRA OU SAIR NO MODO TELA CHEIA: SUPER + B "O CURSOR DO MOUSE PRECISA ESTA DENTRO DO ESPAÇO DO PROGRAMA"

AUMENTAR VOLUME DO SOM: SUPER +

DIMINUIR VOLUME DO SOM: SUPER +
