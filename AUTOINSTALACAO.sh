...
GRUB_CMDLINE_LINUX_DEFAULT=\"quiet noswap noatime nodiratime nowatchdog mitigations=off ibt=off noexec=off split_lock_detect=off split_lock_mitigate=0 noaslr nokaslr\"
GRUB_CMDLINE_LINUX=\"\"
