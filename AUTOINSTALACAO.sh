...
GRUB_CMDLINE_LINUX_DEFAULT=\"quiet tpm_tis.interrupts=0 secureboot=0 noaes noencrypt nohyperv hv_storescsi=0 hv_vmbus=0 hyperv_no_hpet=1 hyperv=off noswap noatime nodiratime nowatchdog mitigations=off nospectre_v1 nospectre_v2 ibt=off noexec=off split_lock_detect=off split_lock_mitigate=0 nopti nopte norandmaps noaslr nokaslr\"
GRUB_CMDLINE_LINUX=\"\"
