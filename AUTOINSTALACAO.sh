...
GRUB_CMDLINE_LINUX_DEFAULT=\"quiet loglevel=0 mitigations=off panic=0 nowatchdog nmi_watchdog=0 softlockup_panic=0 hardlockup_panic=0\"
GRUB_CMDLINE_LINUX=\"\"
